package com.emgram.kr.dobby.config.extra;//package com.emgram.kr.dobby.config.jwt;
//
//
...
//            System.out.println("SecurityContextHolder.getContext().getAuthentication() 111>> "+ SecurityContextHolder.getContext().getAuthentication());
//
//
//            System.out.println("=================UsernamePasswordAuthenticationToken=======================");
//
//             Authentication authentication = authenticationManager.authenticate(authenticationToken);
//            System.out.println("SecurityContextHolder.getContext().getAuthentication() 222>> "+ SecurityContextHolder.getContext().getAuthentication());
...
//        System.out.println("SecurityContextHolder.getContext().getAuthentication() 333>> "+ SecurityContextHolder.getContext().getAuthentication());
//
//
